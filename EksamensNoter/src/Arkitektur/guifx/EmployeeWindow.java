...
import Arkitektur.application.model.Company;
...
public class EmployeeWindow extends Stage {
	...
	private void okAction() {
		...
		if (name.length() == 0) {
			...
			//Laver employment year, lige som wage er lavet.
			...
			//Tilføget employment year i if sætningen.
			if (wage < 0 || employmentYear < 0) {
				lblError.setText("Wage or Employment Year is not a positive number");
			} else {
