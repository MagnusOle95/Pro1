package Arkitektur.guifx;

import Arkitektur.application.controller.Controller;
import Arkitektur.application.model.Employee;
...
public class EmployeePane extends GridPane {
	...
	//Tilføget employmentyear i attributen tekstfelt.
	...
	public EmployeePane() {
		...
		//Tilføger label og texstfelt for ansættelses år.
	...
	public void updateControls() {
		...
		if (employee != null) {
			...
			txfEmploymentYear.setText(employee.getEmploymentYear() + ""); //Tilføger txf employmentyear, så når man trykker på personen, at den skrives i feltet.
			...
			txfCompany.clear();
			txfSalary.clear();
			txfEmploymentYear.clear(); //Tilføger cler, så når man cancler en update ryddes alle felterne i employment pane.
		}
	}
