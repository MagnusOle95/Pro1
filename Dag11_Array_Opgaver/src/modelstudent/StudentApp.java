...
public class StudentApp {
	...
	public static void main(String[] args) {
		...
		System.out.println(s1.getName() + " maxGrade " + s1.maxGrade());
		System.out.println(s1.getName() + " minGrade " + s1.minGrade());
		System.out.println(s2.getName() + " maxGrade " + s2.maxGrade());
		System.out.println(s2.getName() + " MinGrade " + s2.minGrade());
	}
